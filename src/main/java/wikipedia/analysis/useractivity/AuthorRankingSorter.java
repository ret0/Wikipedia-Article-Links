...
//FIXME, legacy class that must be simplified

public class AuthorRankingSorter {

    /**
     * Generate Ranking for top (maxNodes) authors (most edits)
     */
    public static List<ArticleContributions> generateTopAuthorRanking(final Revisions revisionData,
                                                                      int maxNodes) {
        ...
        // Sort by edit count
        ArrayList<Entry<String, Integer>> topUsers = Lists.newArrayList(numberOfArticleEditsPerUser
                .entrySet());
    ...
    private static void storeNumberOfEdits(final Hashtable<String, Integer> numberOfArticleEditsPerUser,
                                           final String userID) {
    ...
    private static int storeEditSizes(final Hashtable<String, Integer> editSizeTable,
